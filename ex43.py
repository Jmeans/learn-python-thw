...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "as the Gothon's blaster cranks a laser past your heard."
            ...
            print "Luck for you they made you learn Gothon insults for academy."
            print "You tell the one Gothon joke you know."
            print "Lbhe zbgure vf fb sng, jura fur nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
            print "The Gothon stops, tries not to laugh, then busts out laughing and can't move."
            print "While he's lauging you run up and shoot him square in the head"
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print "Your then jump back through the door, punch the close button"
            print "and blast the lock to the Gothons can't get out."
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        print "hardly any Gothons are on your ship, so your run is clear of"
        ...
        if int(guess) != good_pod:
            ...
            print "The pod easily slides out into space heating to"
